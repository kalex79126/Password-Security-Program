...
class TermLoading():
    ...
    @property
    def failed(self):
        # Getter for failed attribute
        return self.__failed

    @failed.setter
    def failed(self, failed):
        # Setter for failed attribute
    ...
    def show(self, loading_message: str, finish_message: str = '✅ Finished', failed_message='❌ Failed'):
        # Display loading, finish, or failed messages
...
if __name__ == '__main__':
    # Example usage of the TermLoading class
